...
public class FunctiiDeAutonom extends LinearOpMode {
    ...
    public void Init(HardwareMap hard) {
        ...
        pidRotatie.setTolerance(Pid_Controller_TestConfig.toleranceRotatie);
        pidY.setTolerance(Pid_Controller_TestConfig.toleranceY);
        pidX.setTolerance(Pid_Controller_TestConfig.toleranceX);

        pidRotatie.setPID(Pid_Controller_TestConfig.p, Pid_Controller_TestConfig.i, Pid_Controller_TestConfig.d);
        pidY.setPID(Pid_Controller_TestConfig.py, Pid_Controller_TestConfig.iy, Pid_Controller_TestConfig.dy);
        pidX.setPID(Pid_Controller_TestConfig.px, Pid_Controller_TestConfig.ix, Pid_Controller_TestConfig.dx);
    ...
    public void gotoX(double incrementalX, double maxPow){
        ...
        }while(verifications < Pid_Controller_TestConfig.targetVerifications);
        powerX(0,0,0,0);
    }
